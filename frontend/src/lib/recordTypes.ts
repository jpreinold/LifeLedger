...
export function createRecordInput(type: RecordType): RecordInput {
  ...
  return {
    ...
    renewal_date: null,
    birthday: null,
    birthday_inferred_birth_year: null,
...
export function recordToInput(record: RecordInput | LifeRecord): RecordInput {
  ...
  return {
    ...
    birthday_inferred_birth_year: record.birthday_inferred_birth_year ?? null,
    relationship_context: record.relationship_context ?? null,
...
export function normalizeRecordInput(input: RecordInput): RecordInput {
  ...
  return {
    ...
    birthday_inferred_birth_year: input.birthday_inferred_birth_year ?? null,
    relationship_context: normalizeOptionalText(input.relationship_context ?? null),
