...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("get", "/integrations/google-calendar/status", None),
        ("get", "/integrations/google-calendar/calendars", None),
        ("post", "/integrations/google-calendar/connect", None),
        ...
        (
            "post",
            "/records/example-id/attachments/upload-intent",
            {"filename": "document.pdf", "content_type": "application/pdf", "size_bytes": 128},
        ),
        ("post", "/records/example-id/attachments/attachment-id/complete", None),
        ("get", "/records/example-id/attachments/attachment-id", None),
        ("post", "/records/example-id/attachments/attachment-id/refresh-status", None),
        ("post", "/records/example-id/attachments/attachment-id/download-url", None),
